<script lang="ts">
    ...
    function createOrUpdateMarker(
        metric: MetricsUpdatePacket<"point" | "pose">,
    ): MarkerObject {
    ...
    onMount(() => {
        ...
        // Grid
        const grid = new GridHelper(1.8288 * 2, 6, "#ff0000", "#880000");
        ...
        rws.onPacket("MetricsUpdatePacket", (packet) => {
            ...
            switch (packet.metricType) {
                case "pose":
                    ...
                    const poseMarker = createOrUpdateMarker(
                        packet as MetricsUpdatePacket<"pose">,
                    );
                    let poseX = pose.x / 3.281 / 12;
                    let poseY = pose.y / 3.281 / 12 * -1;
                ...
                case "point":
                    ...
                    const pointMarker = createOrUpdateMarker(
                        packet as MetricsUpdatePacket<"point">,
                    );
