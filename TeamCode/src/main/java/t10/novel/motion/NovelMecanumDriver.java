package t10.novel.motion;

import t10.novel.OmniDriveCoefficients;
import t10.novel.hardware.NovelMotor;
import t10.novel.motion.profiling.TrapezoidalMotionProfile;
import t10.reconstructor.UnstableLocalizationEngine;
...
public class NovelMecanumDriver {
    ...
    public void drive(UnstableLocalizationEngine engine, double lateralInches, double horizontalInches, double acceleration, double maxVelocity) {
