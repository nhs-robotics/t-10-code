...
public class CameraCalibrationOpMode extends AutonomousOpMode {
    ...
    private void calibrateCamera() {
        ...
        /*
         k1.setValue(distCoeffs.get(0, 0)[0]);  // Radial distortion k1
         k2.setValue(distCoeffs.get(1, 0)[0]);  // Radial distortion k2
         p1.setValue(distCoeffs.get(2, 0)[0]);  // Tangential distortion start
         p2.setValue(distCoeffs.get(3, 0)[0]);  // Tangential distortion p2
         k3.setValue(distCoeffs.get(4, 0)[0]);  // Radial distortion k3
         */
