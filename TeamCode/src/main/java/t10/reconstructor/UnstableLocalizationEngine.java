...
@Deprecated
public class UnstableLocalizationEngine {
    ...
    public UnstableLocalizationEngine(IMU imu, AprilTagRetriever aprilTagRetriever, NovelOdometry odometry, Pose initialPosition) {
        this.imu = imu;
