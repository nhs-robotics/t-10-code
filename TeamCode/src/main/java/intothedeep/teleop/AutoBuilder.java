...
//	private Localizer<Pose> odometry;
...
//		this.odometry = (Localizer<Pose>) c.createLocalizer();
...
//						"Press [RB] to save moveTo"});
//				if (gamepad1.right_bumper) {
//					this.driver.halt();
//					String newAutoCode = generateAutoCode(commandType, this.odometry.getFieldCentric());
//					redAutoFileWriter.append(newAutoCode);
//					blueAutoFileWriter.append(newAutoCode);
//					this.odometry.setFieldCentric(new Pose(0, 0, this.odometry.getFieldCentric().getHeading(AngleUnit.DEGREES), AngleUnit.DEGREES));
//					commandTypeSet = false;
//				} else {
//					MovementVector movementVector = new MovementVector(0, 0, 0, AngleUnit.DEGREES);
//
//					switch (commandType) {
//						case VERTICAL:
//							movementVector = new MovementVector(-this.gamepad1.left_stick_y, 0, 0, AngleUnit.DEGREES);
//							break;
//
//						case HORIZONTAL:
//							movementVector = new MovementVector(0, this.gamepad1.left_stick_x, 0, AngleUnit.DEGREES);
//							break;
//
//						case DIAGONAL:
//							movementVector = new MovementVector(-this.gamepad1.left_stick_y, this.gamepad1.left_stick_x, 0, AngleUnit.DEGREES);
//							break;
//
//						case ROTATIONAL:
//							movementVector = new MovementVector(0, 0, this.gamepad1.right_stick_x, AngleUnit.DEGREES);
//							break;
//					}
//
